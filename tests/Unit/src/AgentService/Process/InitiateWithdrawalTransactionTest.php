...
class InitiateWithdrawalTransactionTest extends ProcessTestCase
{
    protected function setUp(): void
    {
        ...
        $this->requestUrl =
            MobileMoney::getBaseUrl() . '/transactions/type/withdrawal';
        $this->requestParams = [
            '{"amount":"200.00","currency":"RWF","creditParty":[{"key":"accountid","value":"2999"}],"debitParty":[{"key":"accountid","value":"2000"}]}'
        ];
        $this->className = InitiateWithdrawalTransaction::class;
