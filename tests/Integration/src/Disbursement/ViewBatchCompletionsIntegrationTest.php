...
class ViewBatchCompletionsIntegrationTest extends IntegrationTestCase
{
    private static $batchTransactionRef;

    protected function getProcessInstanceType()
    {
        return CompletedBatchTransaction::class;
    }

    protected function getResponseInstanceType()
    {
        return BatchCompletion::class;
    }
    ...
    {
        $this->request = Disbursement::viewBatchCompletions(
